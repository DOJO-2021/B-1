...
<body>
  ...
  <main>
    ...
    <form method="POST" action="/Cpull/RegisterServlet">
      ID<input type="text" name="USER_ID" readonly><br>
      PW<input type="hidden" name="USER_PW"> <!-- パスワード非表示/パスワード変更可？ -->
      画像<input type="text" name="USER_IMAGE"><br>
      ...
      受講者<input type="text" name="USER_CLASS" readonly><br><!-- ※受講者/運営表示させる -->
      公開範囲<input type="text" name="USER_RANGE"><br><!-- 公開範囲 -->
